// Me vuela la cabeza esto. Cuando sea una programadora mas experimentada lo volvere a mirar y espero entender mejor. 
...
//accepts the name of a planet, and the age of the dog in seconds.
function dogYears(planet, ageDogSeconds){
   ...
   const ageDogPlanet =  (ageDogSeconds / earthSecondsPerYear / period) * 7

  const rounded = Number(ageDogPlanet.toFixed(2));
  return rounded; // age of dog in dog years

}


// console.log(dogYears('neptune',1000000000 ))